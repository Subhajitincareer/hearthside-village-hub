...
const Footer = () => {
  ...
  return (
    <footer ref={footerRef} className={`bg-forest text-cream ${isVisible ? 'animate-fade-in' : 'opacity-0'}`}>
      <div className="container mx-auto px-4 py-12">
        {/* Newsletter Sign-up */}
        <AnimatedElement animation="slide-up" threshold={0.1}>
            ...
            <div className="text-center max-w-lg mx-auto">
              ...
              <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row gap-2">
                <Input
                  ...
                  className="bg-cream/10 border-cream/20 text-cream placeholder:text-cream/50 h-10 input-focus-effect"
                  value={email}
                  onChange={(e) => setEmail(e.target.value)}
                />
                <Button type="submit" className="bg-sage hover:bg-sage/80 btn-hover-effect">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <AnimatedElement animation="slide-up" delay={1} threshold={0.1}>
            <div className="col-span-1 md:col-span-2">
              ...
              <div className="flex space-x-4 mb-6">
                <a href="#" className="text-cream hover:text-sky transition-colors bg-cream/10 p-2 rounded-full btn-hover-effect">
                  <Facebook size={18} />
                </a>
                <a href="#" className="text-cream hover:text-sky transition-colors bg-cream/10 p-2 rounded-full btn-hover-effect">
                  <Instagram size={18} />
                ...
                <a href="mailto:info@hearthsidevillage.com" className="text-cream hover:text-sky transition-colors bg-cream/10 p-2 rounded-full btn-hover-effect">
                  <Mail size={18} />
                </a>
              </div>
            </div>
          ...
          <AnimatedElement animation="slide-up" delay={2} threshold={0.1}>
            <div>
          ...
          <AnimatedElement animation="slide-up" delay={3} threshold={0.1}>
            <div>
        ...
        <AnimatedElement animation="fade-in" delay={4} threshold={0.1}>
