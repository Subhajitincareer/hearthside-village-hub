        ...
        >
          <AnimatedElement animation="fade-in">
            <div className="flex justify-end mb-6">
              <Link to="/submit">
                <Button className="bg-sage hover:bg-sage/90 text-white btn-hover-effect">
          ...
          <AnimatedElement animation="fade-in" delay={2}>
            ...
            >
              ...
              <TabsContent value="spring" className="mt-6 animate-fade-in">
                <PhotoGallery images={seasons.spring} />
              </TabsContent>
              
              <TabsContent value="summer" className="mt-6 animate-fade-in">
                <PhotoGallery images={seasons.summer} />
              </TabsContent>
              
              <TabsContent value="autumn" className="mt-6 animate-fade-in">
                <PhotoGallery images={seasons.autumn} />
              </TabsContent>
              
              <TabsContent value="winter" className="mt-6 animate-fade-in">
          ...
          {/* Gallery Guidelines */}
          <AnimatedElement animation="slide-up" delay={3}>
